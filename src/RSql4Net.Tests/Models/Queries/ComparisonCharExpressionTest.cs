...
{
    public class ComparisonCharExpressionTest : ComparisonExpressionTest<char>
    {
        protected override char Manifest1()
        {
            return 'A';
        }
        ...
        protected override char Manifest2()
        {
            return 'B';
        }
        ...
        {
            this.Invoking(s => OnShouldThrowInvalidConversionException("aa"))
                .Should()
