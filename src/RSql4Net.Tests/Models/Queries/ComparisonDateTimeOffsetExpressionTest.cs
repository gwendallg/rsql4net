...
{
    public class ComparisonDateTimeOffsetExpressionTest : ComparisonExpressionTest<DateTimeOffset>
    {
        protected override DateTimeOffset Manifest1()
        {
        ...
        protected override DateTimeOffset Manifest2()
        {
